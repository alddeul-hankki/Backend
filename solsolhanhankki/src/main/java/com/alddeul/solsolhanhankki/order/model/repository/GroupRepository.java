...
public interface GroupRepository extends JpaRepository<Groups, Long> {
    ...
    @Query("select g from Groups g where g.storeId = :storeId and g.pickupZone.id = :pickupZoneId and g.scheduledDeadlineAt = :deadlineAt and g.status in (com.alddeul.solsolhanhankki.order.model.enums.GroupStatus.RECRUITING, com.alddeul.solsolhanhankki.order.model.enums.GroupStatus.TRIGGERED)")
    ...
    List<Groups> findAllByStatusAndDeadlineAtBefore(GroupStatus status, OffsetDateTime deadline);
